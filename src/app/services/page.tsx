...
const services = [
	...
	},
	{
		...
		desc: "From helping satisfy app store closed-testing requirements to full automated QA suites — manual and automated testing that catches bugs before your users do.",
		price: "$15 – $2,500",
		features: [
			"Test plan & strategy",
