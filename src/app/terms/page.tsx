...
export default function TermsPage() {
  return (
    <main className="min-h-screen bg-background text-foreground px-4 sm:px-8 py-16 max-w-7xl mx-auto">
      {/* Page Title */}
      <div className="mb-10">
        <h1 className="text-4xl font-bold text-goldenrod-dark dark:text-goldenrod">Terms of Service</h1>
      ...
      <div className="lg:grid lg:grid-cols-[220px_1fr] lg:gap-12">
        ...
        <article className="space-y-10 min-w-0">
          ...
          <section id="overview">
            <h2 className="text-xl font-semibold text-goldenrod-dark/90 dark:text-goldenrod/90 mb-3">1. Overview</h2>
          ...
          <section id="use-of-site">
            <h2 className="text-xl font-semibold text-goldenrod-dark/90 dark:text-goldenrod/90 mb-3">2. Use of the Site</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section id="freelance-services">
            <h2 className="text-xl font-semibold text-goldenrod-dark/90 dark:text-goldenrod/90 mb-3">3. Freelance Services</h2>
            <p className="text-muted-foreground leading-relaxed mb-3">
              The following terms apply to all freelance software development engagements:
            </p>
            <ul className="list-disc list-inside text-muted-foreground space-y-2 leading-relaxed">
              <li>
                <span className="text-foreground">Deposit</span> -- a non-refundable deposit of 50%
                of the agreed project total is required before work begins.
              </li>
              <li>
                <span className="text-foreground">Milestones</span> -- larger projects are broken
                into milestones with payment due at each milestone as agreed in writing.
              </li>
              <li>
                <span className="text-foreground">Final payment</span> -- the remaining balance is
                due in full before final deliverables, source code, or deployment credentials are
                transferred to the client.
              </li>
              <li>
                <span className="text-foreground">Scope changes</span> -- any changes to the agreed
          ...
          <section id="donations">
            <h2 className="text-xl font-semibold text-goldenrod-dark/90 dark:text-goldenrod/90 mb-3">5. Donations</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section id="no-warranty">
            <h2 className="text-xl font-semibold text-goldenrod-dark/90 dark:text-goldenrod/90 mb-3">7. No Warranty</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section id="contact">
            <h2 className="text-xl font-semibold text-goldenrod-dark/90 dark:text-goldenrod/90 mb-3">9. Contact</h2>
            <p className="text-muted-foreground leading-relaxed">
