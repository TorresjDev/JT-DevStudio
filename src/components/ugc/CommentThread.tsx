...
// Optimization: Memoize the component to prevent unnecessary re-renders of the entire tree
// when a single comment is updated or replied to. The recursive nature of comments
// makes this critical for performance.
