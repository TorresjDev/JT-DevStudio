 ...
 * React.memo is used here to prevent unnecessary re-renders of nested comment threads.
 * When a parent comment updates (e.g., editing state), we don't want all child threads
 * to re-render if their props haven't changed.
 */
